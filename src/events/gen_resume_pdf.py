...
async def execute(job_path: Path, ctx: EventContext) -> EventResult:
    ...
    file management system with file_purpose='resume_pdf' and file_source='generated'.
    """
    try:
        ...
        if job_id:
            try:
                ...
                html_path = file_service.get_file_path(job_id, "resume_html")
            except Exception:
        ...
        if job_id:
            ...
            try:
                ...
                return EventResult(
                    ok=True,
                    job_path=job_path,
                    message=f"Generated resume.pdf, stored at {job_file.file_path}",
