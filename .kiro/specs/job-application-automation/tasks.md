...
- [x] 5. Implement phase transition events
  ...
  - [x]* 5.3 Write property test for phase transition logging
...
- [x] 7. Implement data validation
  ...
  - [x]* 7.2 Write property test for job YAML validation
    - **Property 9: Job YAML Validation**
    - **Validates: Requirements 4.7, 14.1, 14.2**

- [x] 8. Implement log_message and notify_user events
  - [x] 8.1 Create log_message event
    - Implement execute() to append to job.log
    - Format: {YYYY-MM-DD HH:MM:SS} - {context} - {message}
    - _Requirements: 8.1, 8.2_

  - [x] 8.2 Create notify_user event
    - Implement execute() to send WebSocket message
    - Also call log_message
    - Include job_folder_name in notification
    - _Requirements: 9.1, 9.2, 9.3_

  - [x]* 8.3 Write property test for log entry format
    - **Property 14: Log Entry Format**
    - **Validates: Requirements 8.2, 8.3**

- [x] 9. Implement job data collection events
  - [x] 9.1 Create get_gmail_linkedin event
    - Connect to Gmail via IMAP
    - Search for "LinkedIn Job Alert" emails from last 2 weeks
    - Parse email HTML to extract job listings (company, title, location, salary, tags)
    - Extract LinkedIn job ID from URL (e.g., "4352500475" from "https://www.linkedin.com/jobs/view/4352500475")
    - Extract email sent date/time and use as job date field (not current date)
    - Remove /comm/ from LinkedIn URLs (use https://www.linkedin.com/jobs/view/{id}/ format)
    - For each job: fetch HTML from LinkedIn URL and save to job.html
    - Parse job.html to extract full job description
    - Create job folders for each listing with proper job ID and complete description
...
- [x] 10. Implement LLM interface
  - [x] 10.1 Create LLM abstraction layer
...
- [x] 11. Implement content generation events
  - [x] 11.1 Create gen_llm_subcontent_* events
  ...
  - [x] 11.2 Create gen_static_subcontent_* events
  ...
  - [x]* 11.3 Write property test for static content round trip
    - **Property 10: Static Content Round Trip**
    - **Validates: Requirements 6.1, 6.2**

  - [x]* 11.4 Write property test for subcontent event configuration
    - **Property 25: Subcontent Event Configuration**
    - **Validates: Requirements 5.3, 6.5**

- [x] 12. Implement batch_gen_data event
  - [x] 12.1 Create batch_gen_data event
  ...
  - [x]* 12.2 Write property test for subcontent file completeness
    - **Property 11: Subcontent File Completeness**
    - **Validates: Requirements 7.1, 22.1**

- [x] 13. Checkpoint - Ensure content generation tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 14. Implement document generation utilities
  - [x] 14.1 Create CSS generation
  ...
  - [x]* 14.4 Write property test for CSS file generation
    - **Property 12: CSS File Generation**
    - **Validates: Requirements 7.4, 7.5**

  - [x]* 14.5 Write property test for HTML to PDF dependency
    - **Property 13: HTML to PDF Dependency**
    - **Validates: Requirements 22.2**

- [x] 15. Implement document generation events
  - [x] 15.1 Create gen_resume_html event
    - Validate all subcontent files exist
    - Call generate_resume_html()
    - Overwrite existing file
    - _Requirements: 7.1, 7.2, 7.10_

  - [x] 15.2 Create gen_coverletter_html event
    - Validate subcontent.coverletter.yaml exists
    - Call generate_coverletter_html()
    - Overwrite existing file
    - _Requirements: 7.8, 7.10_

  - [x] 15.3 Create gen_resume_pdf event
    - Validate resume.html exists
    - Call generate_pdf()
    - Overwrite existing file
    - _Requirements: 7.7, 7.10_

  - [x] 15.4 Create gen_coverletter_pdf event
    - Validate coverletter.html exists
    - Call generate_pdf()
    - Overwrite existing file
    - _Requirements: 7.9, 7.10_

- [x] 16. Implement batch_gen_docs event
  - [x] 16.1 Create batch_gen_docs event
...
- [x] 17. Implement error handling and recovery
  ...
  - [x]* 17.4 Write property test for retry logic
    - **Property 16: Retry Logic**
    - **Validates: Requirements 10.1, 10.2**

- [x] 18. Implement S3 upload event
  - [x] 18.1 Create upload_s3 event
...
- [x] 19. Checkpoint - Ensure document generation tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 20. Implement Flask web server
  - [x] 20.1 Create Flask app structure
    - Set up Flask app with routes
    - Configure static files and templates
    - Add CORS support
    - _Requirements: 12.1_

  - [x] 20.2 Create WebSocket manager
    - Implement broadcast_toast()
    - Implement broadcast_job_update()
    - Implement broadcast_phase_update()
    - _Requirements: 21.9_

- [x] 21. Implement dashboard UI
  - [x] 21.1 Create base HTML template
...
- [x] 22. Implement job card UI variations
  - [x] 22.1 Create Queued phase job card
  ...
  - [x] 22.2 Create Data Generated phase job card
  ...
  - [x] 22.3 Create Docs Generated and higher phase job card
...
- [x] 23. Implement interactive UI elements
  - [x] 23.1 Add click handlers for navigation
  ...
  - [x] 23.2 Add click handlers for actions
  ...
  - [x] 23.3 Add visual feedback
    - Hover effects for clickable elements
    - Cursor changes
    - Loading indicators
    - _Requirements: 20.10_

- [x] 24. Implement dynamic UI updates
  - [x] 24.1 Add WebSocket client
  ...
  - [x] 24.2 Implement real-time icon updates
...
- [x] 25. Implement API endpoints
  - [x] 25.1 Create job management endpoints
  ...
  - [x] 25.2 Create data collection endpoints
    - POST /api/fetch_email
    - POST /api/add_url
    - POST /api/manual_entry
    - _Requirements: 24.1, 24.2, 24.3, 24.4, 24.5, 24.6_

  - [x] 25.3 Create utility endpoints
    - GET /api/logs
    - GET /api/job_stats
    - GET /api/resumes
...
- [x] 26. Implement resume selection
  - [x] 26.1 Create resume discovery
    - Scan resumes/ directory for .yaml files
    - Populate dropdown
    - _Requirements: 25.1, 25.2_

  - [x] 26.2 Implement resume persistence
...
- [x] 27. Implement phase filtering
  - [x] 27.1 Create filtering logic
...
- [x] 28. Implement batch processing
  - [x] 28.1 Create batch processing button
  ...
  - [x] 28.2 Add batch processing feedback
...
- [x] 29. Implement log file rotation
  - [x] 29.1 Add daily log rotation
...
- [x] 30. Implement folder name correction
  - [x] 30.1 Add folder validation and correction
...
- [x] 31. Final checkpoint - Ensure all tests pass
  - All tests passing (16 property tests + 1 e2e test + 14 Flask tests)

- [x] 32. Integration testing and polish
  - [x] 32.1 Test end-to-end workflows
    - Create job → Generate data → Generate docs → Move to Applied
    - Test error recovery and retry logic
    - Test batch processing
    - _Requirements: All_

  - [x] 32.2 Add error handling polish
    - Improve error messages
    - Add user-friendly error displays
    - Test all error paths
    - _Requirements: 10.1-10.7_

  - [x] 32.3 Performance optimization
    - Optimize file I/O
    - Cache frequently accessed data
    - Test with large job queues
    - _Requirements: Performance considerations_

  - [x] 32.4 Security review
